...
class OciNetworkOps(object):
    ...
    def add_inet_gw_route(self, route_table_id, inet_gw_id=None, vcn_id=None, cidr=DEFAULT_CIDR):
        ...
        if security_list_ingress_rules:
            return self.network_client_ops.create_security_list_and_wait_for_state(
                oci.core.models.CreateSecurityListDetails(
                    ...
                    egress_security_rules=[oci.core.models.EgressSecurityRule(destination=self.DEFAULT_CIDR,
                                                                              protocol="all")]
                ),
    ...
    def create_subnet(self, subnet_cidr, name, vcn_ocid, route_table_id, availability_domain):
